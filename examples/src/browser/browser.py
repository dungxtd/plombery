...
from config.config import is_dev, get_chrome_binary_location, get_chromedriver_path
if not is_dev():
...
class Browser(object):
    ...
    def _set_browser(self) -> None:
        ...
        if is_dev():
            ...
            self._BROWSER = webdriver.Chrome(ChromeDriverManager(print_first_line=False).install(),
                                            options=options)
