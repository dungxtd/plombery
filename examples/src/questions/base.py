...
from config.selectors import get_title_selector, get_description_selector, get_required_selector
...
class BaseQuestion(AbstractQuestion):
    ...
    # Define constants
    _TITLE_CSS_SELECTOR = get_title_selector()  # Question Title
    _DESCRIPTION_CSS_SELECTOR = get_description_selector()  # Question Description
    _REQUIRED_CSS_SELECTOR = get_required_selector()  # Required Asterisk
    ...
    def get_info(self) -> Optional[bool]:
        ...
        # Obtain question metadata
        header = str(self._QUESTION_ELEMENT.find_element(By.CSS_SELECTOR, self._TITLE_CSS_SELECTOR).text)
        self.set_description(str(self._QUESTION_ELEMENT.find_element(By.CSS_SELECTOR, self._DESCRIPTION_CSS_SELECTOR).text))
        try:
            self.set_required(bool(self._QUESTION_ELEMENT.find_element(By.CSS_SELECTOR, self._REQUIRED_CSS_SELECTOR)))
