...
from config.selectors import get_checkbox_selector, get_checkbox_other_selector
...
class CheckboxQuestion(BaseOptionQuestion):
    ...
    # Define constants
    _CSS_SELECTOR_NAME = get_checkbox_selector()  # Checkboxes
    _OTHER_CSS_SELECTOR = get_checkbox_other_selector()  # 'Other' Input Field
