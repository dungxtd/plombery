...
from config.selectors import get_dropdown_selector, get_dropdown_menu_selector, get_dropdown_placeholder_selector
...
class DropdownQuestion(BaseOptionQuestion):
    ...
    """
    # Define constants
    _DROPDOWN_CSS_SELECTOR = get_dropdown_selector()  # Drop-down Options
    _DROPDOWN_MENU_CSS_SELECTOR = get_dropdown_menu_selector()  # Drop-down Menu
    _PLACEHOLDER_CSS_SELECTOR = get_dropdown_placeholder_selector()  # Drop-down placeholder
    _BUFFER_SECONDS = 1
    # region Getters and Setters

    @classmethod
    def get_css_selector_name(cls) -> str:
        """Helper function to get the drop-down option web element CSS selector.

        :return: The drop-down option web element CSS selector.
        """

        return cls._DROPDOWN_CSS_SELECTOR
    ...
    def get_info(self) -> Optional[bool]:
        ...
        placeholder = self._QUESTION_ELEMENT.find_element(By.CSS_SELECTOR, self._PLACEHOLDER_CSS_SELECTOR)
        # Instruction: Click the placeholder to open the dropdown menu
        placeholder.click()

        # Obtain the dropdown menu element
        menu = self._QUESTION_ELEMENT.find_element(By.CSS_SELECTOR, self._DROPDOWN_MENU_CSS_SELECTOR)
        menu_elements = menu.find_elements(By.CSS_SELECTOR, self._DROPDOWN_CSS_SELECTOR)
