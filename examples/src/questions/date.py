...
class DateQuestion(BaseQuestion):
    ...
    def get_info(self) -> Optional[bool]:
        ...
        date_picker_elements = self._QUESTION_ELEMENT.find_elements(By.XPATH,
            ".//input[contains(@type, '{}')]".format(self._DATE_TYPE))
        month_elements = self._QUESTION_ELEMENT.find_elements(By.XPATH,
            ".//input[contains(@aria-label, '{}')]".format(self._MONTH_ARIA_LABEL))
        day_elements = self._QUESTION_ELEMENT.find_elements(By.XPATH,
