...
from config.selectors import get_paragraph_selector
...
class LAQuestion(BaseQuestion):
    ...
    """
    # Define constants
    _PARA_CSS_SELECTOR_NAME = get_paragraph_selector()
    ...
    def get_css_selector_name(cls) -> str:
        ...
        return cls._PARA_CSS_SELECTOR_NAME
    ...
    def get_info(self) -> Optional[bool]:
        ...
        self.set_answer_elements(self._QUESTION_ELEMENT.find_element(By.CSS_SELECTOR, self._PARA_CSS_SELECTOR_NAME))
        return True
